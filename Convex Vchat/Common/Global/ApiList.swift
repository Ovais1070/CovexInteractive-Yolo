...
enum Base : String{
    ...
    case phoneNumVerify = "check-user"
    case signUp = "register"
    case sendOtp = "send-otp"
    case sendOtpSignup = "send-otp-signup"
    ...
    //  case servicesList = "/api/user/services/fare"

    case estimateFare = "/api/user/estimated/fare"
    case getProviders = "/api/user/show/providers"
    case unCapturePayment = "api/user/uncapturepayment"
