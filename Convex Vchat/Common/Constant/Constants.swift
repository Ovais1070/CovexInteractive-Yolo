...
struct Constants {
    ...
    let google = "Google"
    let payment = "Payment"
    let rideHistory = "Pickup History"
    let getARide = "Get A Pickup"

    let coupon = "ADD PROMO"
    let wallet = "Wallet"
    ...
    let ETA = "ETA"
    let model = "Model"
    let useWalletAmount = "Wallet"
    let scheduleRide = "Schedule"
    let rideNow = "confirm pickup"
    let scheduleARide = "Schedule"
    let select = "Select"
    ...
    let offer = "Promo & Coupons"
    let amount = "Amount"
    let creditedBy = "Credited By"
    let CouponCode = "Coupon Code"
    let OFF = "OFF"
    let couldnotOpenEmailAttheMoment = "Could not open Email at this moment."
